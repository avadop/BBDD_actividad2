...
INSERT INTO cliente(dni, correo_electronico, direccion, nombre, apellidos, telefono, contrasenya) VALUES ('01189877H', 'andrea@gmail.com', 'Madrid', 'Andrea', 'del Vado Puell', 666985589,'andrea123!');
INSERT INTO cliente(dni, correo_electronico, direccion, nombre, apellidos, telefono, contrasenya) VALUES ('12345678Z', 'pablo@gmail.com', 'Galicia', 'Palbo', 'Vazquez Fernandez', 912547896,'pablo123!');
INSERT INTO cliente(dni, correo_electronico, direccion, nombre, apellidos, telefono, contrasenya) VALUES ('98745632C', 'joaquin@gmail.com', 'Córdoba', 'Joaquin Ángel', 'Tejero Cañero', 689951123, 'joaquin123!');
INSERT INTO cliente(dni, correo_electronico, direccion, nombre, apellidos, telefono, contrasenya) VALUES ('44556677G', 'fulanito@gmail.com', 'Asturias', 'fulanito', 'García López', 673357896,'fulanito123!');
INSERT INTO cliente(dni, correo_electronico, direccion, nombre, apellidos, telefono, contrasenya) VALUES ('58236478A', 'menganito@gmail.com', 'Navarra', 'menganito', 'Perez Almansa', 915642365,'menganito123!');
